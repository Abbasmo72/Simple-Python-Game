...
برای مشاهده فایل <b>[English README.md](Snake/SnakePersian.py)</b> و <b>[Persian README.md](Snake/SnakePersian.md)</b> کد کامل بازی <b>[Python Code](Snake/SnakeEnglish.md)</b>.
<hr>
